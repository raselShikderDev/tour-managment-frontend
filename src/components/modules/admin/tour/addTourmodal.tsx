...
export function AddTourModal() {
  ...
  const onsubmit = async (data: any) => {
    ...
    const tourData = {
      ...
      excluded: data.excluded.map((item: any) => item.value),
      amenities: data.amenities.map((item: any) => item.value),
      tourPlan: data.tourPlan.map((item: any) => item.value),
    };
  ...
  console.log("in formData: ", key, value);
}
